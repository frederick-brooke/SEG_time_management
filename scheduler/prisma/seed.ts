...
const SHOP_ITEMS = [
  ...
  {
    name: "Nebula Scout",
    description: "You've explored the edges of the known universe.",
    type: "TITLE" as const,
    price: 250,
    value: "Nebula Scout",
    icon: "🌌",
  ...
  {
    name: "Star Commander",
    description: "You command the stars.",
    type: "TITLE" as const,
    price: 500,
  ...
  {
    name: "Void Walker",
    description: "You move through darkness others fear.",
    type: "TITLE" as const,
    price: 750,
    value: "Void Walker",
    icon: "🌑",
  ...
  {
    name: "Nebula Glow",
    description: "A dreamy purple-pink cosmic glow.",
    type: "FRAME" as const,
    price: 400,
    value: "nebula-glow",
    icon: "💜",
  ...
  {
    name: "Aurora Ring",
    description: "Northern lights dancing around your profile.",
    type: "FRAME" as const,
    price: 600,
    value: "aurora-ring",
    icon: "🌈",
  ...
  {
    name: "Event Horizon",
    description: "The legendary black hole frame.",
    type: "FRAME" as const,
    price: 2000,
    value: "event-horizon",
    icon: "🕳️",
