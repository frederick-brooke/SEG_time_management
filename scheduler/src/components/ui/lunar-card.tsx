...
export function LunarCard({ children, className = "", variant = "blue", id }: LunarCardProps) {
    const variants = {
    ...
    return (
        <div id={id} className={`group relative overflow-hidden rounded-[2rem] border backdrop-blur-xl transition-all hover:-translate-y-1 ${variants[variant]} ${className}`}>
            {/* Nebula Glow */}
