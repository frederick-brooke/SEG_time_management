...
function ModuleHeader({
	...
	return (
		<div className="flex items-start justify-between gap-3 mb-1">
			...
			{isOwner && (
				<span className="text-[9px] px-2.5 py-1 rounded-lg bg-blue-500/10 text-blue-300 border border-blue-500/20 font-black uppercase tracking-widest shrink-0 shadow-[0_0_10px_rgba(147,197,253,0.2)]">
					OWNER
				</span>
			)}
		</div>
		...
		<div className="flex items-center gap-4 lunar-card bg-white/5 p-5 transition-all hover:bg-white/10 hover:border-white/30 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)] border border-white/10">
			...
			<div className="flex-1 min-w-0">
				...
				<ModuleFooter
					...
					username={module.creator.username}
				/>
			</div>
