		...
		<div className="flex justify-between items-center pt-3 border-t border-white/10 w-full mt-2">
			<div className="flex items-center gap-2">
				...
				<Checkbox
					...
					className="h-5 w-5 bg-transparent border-white/40 data-[state=checked]:bg-blue-300 data-[state=checked]:text-black"
				/>
	...
	return (
		...
		>
			<LunarCard
				id={`task-${task.id}`}
				variant="blue"
				className={`p-3 mb-2 rounded-2xl transition-all duration-300 relative z-10 ${
					isDashboard
			...
			>
				<div
					className={`flex flex-col gap-2.5 w-full ${isDashboard ? "pointer-events-none" : "gap-2.5"}`}
				>
					<div className="flex-1 min-w-0">
						...
						<div className="flex flex-row gap-2 mt-1.5 flex-wrap">
							{task.duration > 0 && (
