	...
	return (
		<Card className="bg-transparent border-none shadow-none @container/Card overflow-visible">
			<CardHeader className="px-0 pt-0">
				<CardTitle className="text-5xl font-black tracking-tighter text-white uppercase">
					TO DO LIST
				</CardTitle>
				<CardDescription className="text-white/40 font-bold uppercase tracking-[0.3em] text-[12px] mt-2">
			...
			<div className="px-0 mb-10">
				<div className="mt-4">
					<input
						...
						className="w-full max-w-md p-2 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-[10px] font-black uppercase tracking-[0.2em] text-white placeholder:text-white/20 focus:ring-blue-500/40 transition-all backdrop-blur-md outline-none"
						value={searchQuery}
			...
			<CardContent className="px-4">
				{examFilteredTasks.length === 0 ? (
					<div className="text-center py-8 text-muted-foreground">
						<p>
							No tasks yet. Click "New" to create your first task!
						</p>
					</div>
				) : (
