...
export default function SearchPanel({ open, onClose }) {
    ...
    <>
      ...
      {/* drawer */}
        <div className={`fixed top-0 left-0 h-screen w-[500px] bg-gradient-to-b from-gray-900 via-indigo-900 to-blue-900 border-r shadow-2xl z-50 transform transition-transform duration-300 ease-out ${open ? "translate-x-0" : "-translate-x-full"}`}>
            {/* header */}
