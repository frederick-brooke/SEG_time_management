...
export default function UserCard({
	...
	return (
		<GlassCard
			onClick={onClick}
			className="p-1.5 cursor-pointer hover:scale-[1.01] transition-transform duration-300"
		>
			<div className="flex items-center gap-2 w-full">
				...
				{onRemove && (
					<button
						...
						className="ml-auto flex-shrink-0 text-gray-400 hover:text-red-500 transition"
					>
						<IconX size={16} />
					</button>
				)}
