...
export function CalendarEvents() {
	...
	if (isLoading)
		return (
			<div className="p-4 text-white/20 text-[10px] animate-pulse">
				Loading data
			</div>
		);
				...
				{events.length === 0 ? (
					...
					<div className="space-y-3">
						{events.map((event: any, i) => (
							<div
								key={i}
								className="group p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 transition-all"
							>
