...
function DeadlineBadge({ task, events }: { task: any; events: any[] }) {
  ...
  return (
    <span className="text-xs italic" style={{ color: "rgba(148,163,255,0.35)" }}>
      No deadline
    </span>
  );
}
  ...
  return (
    <div className="w-64 flex-shrink-0 flex flex-col gap-4 sticky top-4 self-start">
      ...
      <div className="bg-white/[0.03] border border-white/[0.08] backdrop-blur-md rounded-2xl p-4">
        <h2 className="font-bold text-[rgba(220,225,255,0.9)] mb-3 text-sm" style={{ letterSpacing: "0.02em" }}>
          Unscheduled Tasks
        </h2>
        {unscheduledTasks.length === 0 ? (
          <p className="text-xs" style={{ color: "rgba(148,163,255,0.35)" }}>
          ...
          <div className="flex flex-col gap-3 max-h-96 overflow-y-auto">
            {scheduleLogs.map((log) => (
              ...
              >
                  ...
                  <span
                    className={`text-xs font-bold px-2 py-0.5 rounded-full border ${
                      log.mode === "day"
                        ...
                        : "bg-[rgba(148,163,255,0.15)] text-[rgba(148,163,255,0.9)] border-[rgba(148,163,255,0.25)]"
                    }`}
                  >
                    {log.mode === "day" ? "Day" : "Week"}
                  </span>
                  <span className="text-xs text-[rgba(148,163,255,0.4)]">
                ...
                <p className="text-xs mb-2 text-[rgba(148,163,255,0.45)]">
