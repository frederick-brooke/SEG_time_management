			...
			<div className="grid grid-cols-2 gap-2">
				...
				<div>
					...
					<div className="relative mt-1">
						...
						>
							<option value="Low" className="bg-[#1a1a24]">
								Low
							</option>
							<option value="Medium" className="bg-[#1a1a24]">
								Medium
							</option>
							<option value="High" className="bg-[#1a1a24]">
								High
							</option>
						</select>
			...
			<div className="p-3 bg-white/5 rounded-xl border border-white/[0.07] flex flex-col gap-2">
				...
				{scheduleTime ? (
					...
					<p className="text-xs text-white/30">
						Task will appear in Unscheduled Tasks — you can place it
						later.
					</p>
				)}
			</div>
