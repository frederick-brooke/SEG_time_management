...
/**
 * Renders the total accumulated points section of the card.
 */
...
/**
 * Renders the progress bar and next level requirements.
 */
function LevelProgressDisplay({ level, xpToNext, xpBarWidth }: Omit<PointsCardProps, 'totalPoints'>) {
  return (
    <div className="flex items-center gap-6">
      <div className="text-center">
        <p className="lunar-label text-white">Level</p>
        <p className="text-3xl font-black text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">{level}</p>
      </div>
      <div className="text-center">
