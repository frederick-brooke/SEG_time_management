/**
 * Task utilities for priority styling, deadlines, formatting, and data normalization.
 * Includes helpers for due-date logic, duration formatting, and task form transformation.
 */
