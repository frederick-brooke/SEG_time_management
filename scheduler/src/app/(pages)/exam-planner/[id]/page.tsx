...
/**
 * An editable topic row in the syllabus builder.
 * @param {Object} topic The topic object containing title, duration and url.
...
/**
 * Syllabus builder panel for defining revision topics.
 * @param {Array} topics List of topic objects to render.
 * @param {Function} onAdd Callback to add a new blank topic.
 * @param {Function} onUpdate Callback to update a topic field.
