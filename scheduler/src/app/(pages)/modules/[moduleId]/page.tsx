...
export default async function ModuleDetailPage({
			...
			<div className="p-8">
				<div className="max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
					...
					<p className="mt-2 text-gray-600">
						This module does not exist or you do not have access to
						it.
					</p>
				</div>
			</div>
	...
	const isOwnerOrAdmin =
		module.userRole === ModuleRole.OWNER ||
		module.userRole === ModuleRole.ADMIN;
	...
	const [events, tasks, tasksWithProgress] = await Promise.all([
		...
		isOwnerOrAdmin
			? getModuleTasksWithProgress(moduleId)
			: Promise.resolve([]),
	]);
