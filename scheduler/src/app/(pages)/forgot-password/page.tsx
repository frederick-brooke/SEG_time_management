			...
			<div className="w-full max-w-md relative z-10">
				<div className="bg-white/[0.02] border border-white/10 rounded-3xl p-8 md:p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)] backdrop-blur-xl">
					...
					{status !== "success" ? (
						...
						<Link
							href="/login"
							className="w-full inline-block bg-white/5 hover:bg-white/10 text-white text-center font-semibold py-3.5 rounded-xl transition-all"
						>
							Return to Login
						</Link>
					)}
					...
					<div className="mt-8 pt-6 border-t border-white/10 text-center">
						<Link
							href="/login"
							className="text-sm font-medium text-white/40 hover:text-white flex items-center justify-center gap-2 transition-colors"
						>
